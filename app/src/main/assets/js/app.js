...
const FURNITURE_CATEGORIES = [
    ...
    { id: "office-tables", name: "Office Tables & Desks" },
    { id: "wardrobes", name: "Wardrobes & Cabinets" },
    { id: "bookshelves", name: "Bookshelves & Wall Units" },
    { id: "sofas", name: "Sofas & Living Room Seating" },
    { id: "lounge-chairs", name: "Accent & Lounge Chairs" },
    { id: "office-chairs", name: "Office & Ergonomic Chairs" },
    { id: "dining-chairs", name: "Dining Chairs & Stools" },
    { id: "kitchen-cabinets", name: "Modular Kitchen Cabinets" },
    { id: "outdoor-sets", name: "Outdoor & Patio Sets" },
    { id: "metal-wood", name: "Custom Metal-Wood Fusion" },
    { id: "accessories", name: "Decorative Accessories" }
];
